...
names = ['prd','client','cat','subcat','dg']
f= open("New_Final_all_training_data.csv")
f.next()
...
cat_confidence = pipeline.predict_proba(x_test)
...
writer = csv.writer(open('Regression_Result_DG_test_data_with_confidence.csv','w'))
