...
#classifier
pipeline= Pipeline([
	#('vect',sklearn.feature_extraction.text.CountVectorizer(stop_words= None,ngram_range=(1,3))),
...
vectorizer= CountVectorizer(stop_words=None,ngram_range=(1,3))
#vectorizer =StemmedCountVectorizer(stop_words= None,ngram_range=(1,3))
...
pipeline.fit(X_vectorized,train_label)
...
print("testing done in %0.3fs"%(time()-t1))
